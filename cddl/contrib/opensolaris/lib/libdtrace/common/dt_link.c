...
dump_elf32(dtrace_hdl_t *dtp, const dof_hdr_t *dof, int fd)
{
	...
	elf_file.ehdr.e_flags |= EF_LOONGARCH_ABI_LP64_SOFT_FLOAT;
#endif
#if defined(__loongarch_single_float)
	elf_file.ehdr.e_flags |= EF_LOONGARCH_ABI_LP64_SINGLE_FLOAT;
#endif
#if defined(__loongarch_double_float)
	elf_file.ehdr.e_flags |= EF_LOONGARCH_ABI_LP64_DOUBLE_FLOAT;
#endif
#endif
